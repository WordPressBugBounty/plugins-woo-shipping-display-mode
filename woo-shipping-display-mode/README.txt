...
This Plugin is useful when you are using 4.0 or higher  version of WooCommerce and you have to use more than 20 or 30 or more then that Shipping Method at that time you do not have forced to display all shipping method only using radio button, but you have also chosen a select option for display shipping mode and by choosing select option shipping method is displayed in the drop down box so you can avoid lengthy listing of shipping method.
...
<ol>
<li><a href ="https://www.thedotstore.com/flat-rate-shipping-plugin-for-woocommerce/" target="_blank">Flat-rate shipping plugins for WooCommerce</a></li>
...
= 3.7.6 =
* New – Option to make the plugin compatible with customised themes like Flatsome
* Fixed – Cart & checkout page design breaking issue with dropdown option
* Update – Compatible with Flatsome & Exs Boxed Theme
* Update – Compatible with WooCommerce 7.0.x
...
= 3.0 - 28-08-2019 =
* Shipping option does not stay selected issue has been fixed.
